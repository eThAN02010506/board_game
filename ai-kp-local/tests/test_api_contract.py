...
EXPECTED_HTTP_ROUTES = {
    ...
    ("POST", "/investigators/{investigator_id}/timeline-branches"),
    ("GET", "/investigators/{investigator_id}/timeline"),
    ("GET", "/investigators/{investigator_id}/permanent-changes"),
    ("POST", "/investigator-permanent-changes/{proposal_id}/decision"),
    ...
    ("GET", "/campaigns/{campaign_id}/investigators/{investigator_id}/timeline"),
    ("POST", "/campaigns/{campaign_id}/investigators/{investigator_id}/permanent-changes"),
    ...
    ("GET", "/campaigns/{campaign_id}/module-runs"),
    ("GET", "/campaigns/{campaign_id}/module-runs/current"),
    ("POST", "/campaigns/{campaign_id}/module-runs"),
    ...
    ("POST", "/kp/proposals/{proposal_id}/world-expansion-encounters"),
    ...
    ("POST", "/sessions/{session_id}/recaps/generate"),
    ("GET", "/sessions/{session_id}/recaps/latest"),
    ("POST", "/session-recap-candidates/{candidate_id}/review"),
    ...
    ("GET", "/campaigns/{campaign_id}/npc-reappearance-candidates"),
    ("GET", "/campaigns/{campaign_id}/npcs"),
    ("PUT", "/campaigns/{campaign_id}/npcs/{npc_id}/availability"),
    ("PUT", "/campaigns/{campaign_id}/npc-reappearance-policy"),
    ("GET", "/campaigns/{campaign_id}/npc-reappearance-policy"),
    ("GET", "/campaigns/{campaign_id}/travel-graph"),
    ("POST", "/campaigns/{campaign_id}/travel-locations"),
    ("DELETE", "/campaigns/{campaign_id}/travel-locations/{location_id}"),
    ("POST", "/campaigns/{campaign_id}/travel-routes"),
    ("DELETE", "/campaigns/{campaign_id}/travel-routes/{route_id}"),
    ("POST", "/campaigns/{campaign_id}/travel-route-preview"),
    ("GET", "/campaigns/{campaign_id}/npc-hidden-appearances"),
    ("POST", "/campaigns/{campaign_id}/npc-hidden-appearances"),
