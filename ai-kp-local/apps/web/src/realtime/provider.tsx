/** Realtime workspace lifecycle and event refresh coordination. */
...
type RefreshKind = "identity" | "members" | "seats" | "checks" | "pcs" | "actions" | "proposals" | "maps";
...
function refreshKindsForEvent(event: RealtimeEvent): RefreshKind[] {
  ...
  if (event.event_type.startsWith("session.seat_")) return ["seats", "members"];
  if (event.event_type.startsWith("check.")) return ["checks", "actions"];
